...
for script in build_scripts:
    ...
    process = subprocess.run([script], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
    ...
    keywords = ["cannot find", "fault", "unable", "error", "Error", "Unable", "No such file or directory", "warning", "undeclared"]
