...
# powershell open MessageBox with an ok button
set_command_source static_from_here "Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Click OK to Proceed!' , 'Interactive')"
