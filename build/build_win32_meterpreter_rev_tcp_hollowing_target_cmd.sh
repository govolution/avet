...
# The format of the third parameter is expected to be as follows:	<process to hollow into>,<parent command line of new process>
...
# Specifies the parent command line of the newly created process. This will be passed internally as an argument for CreateProcess.
# So you can basically spoof the parent command line of your hollowing target here.
#
# !!!
